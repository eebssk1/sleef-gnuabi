...
static INLINE vdouble vfma_vd_vd_vd_vd(vdouble x, vdouble y, vdouble z) {
  ...
  az[2] = tlfloat_fma(ax[2], ay[2], az[2]);
  az[3] = tlfloat_fma(ax[3], ay[3], az[3]);
...
static INLINE vfloat vfma_vf_vf_vf_vf(vfloat x, vfloat y, vfloat z) {
  ...
  az[4] = tlfloat_fmaf(ax[4], ay[4], az[4]);
  az[5] = tlfloat_fmaf(ax[5], ay[5], az[5]);
  az[6] = tlfloat_fmaf(ax[6], ay[6], az[6]);
  az[7] = tlfloat_fmaf(ax[7], ay[7], az[7]);
